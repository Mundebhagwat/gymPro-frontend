...
//         const activeSessions = data.activeSessions || { count: 0, change: '0%' };
//         const missedSessions = data.missedSessions || { count: 0, change: '0%' };
...
//           {
//             title: 'Active Trainers',
//             value: activeTrainers.count.toString(),
//             change: activeTrainers.change,
//             trend: activeTrainers.change.startsWith('-') ? 'down' : 'up',
//             icon: <Users size={40} />,
//             color: '#4CAF50',
//             bgGradient: 'linear-gradient(135deg, #4CAF50 0%, #45a049 100%)',
//           },
//           {
//             title: 'Active Sessions',
//             value: activeSessions.count.toString(),
//             change: activeSessions.change,
//             trend: activeSessions.change.startsWith('-') ? 'down' : 'up',
//             icon: <Play size={40} />,
//             color: '#2196F3',
//             bgGradient: 'linear-gradient(135deg, #2196F3 0%, #1976D2 100%)',
//           },
//           {
//             title: 'Missed Sessions',
//             value: missedSessions.count.toString(),
//             change: missedSessions.change,
//             trend: missedSessions.change.startsWith('-') ? 'down' : 'up',
//             icon: <X size={40} />,
//             color: '#FF5722',
//             bgGradient: 'linear-gradient(135deg, #FF5722 0%, #D32F2F 100%)',
//           },
...
//         setPerformanceData([
//           { metric: 'Session Completion', value: metrics.sessionCompletion || 0, color: '#4CAF50' },
//           { metric: 'Trainer Efficiency', value: metrics.trainerEfficiency || 0, color: '#2196F3' },
//           { metric: 'Client Satisfaction', value: metrics.clientSatisfaction || 0, color: '#FF9800' },
//           { metric: 'Revenue Growth', value: metrics.revenueGrowth || 0, color: '#9C27B0' },
//         ]);

//         setRecentActivities(activities); // currently empty in sample
//       } catch (error) {
